...
class _FormState extends State<FormContact_Page> {
  FormContact_Functionality formContact_Functionality =
      new FormContact_Functionality();
  ...
  void LoadData_Function() async {
    isSession =
        await formContact_Functionality.CheckID(); //Revisa si hay sesion,
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: TextField(
                  controller:
                      formContact_Functionality.contactNumber_Controller,
                  decoration: InputDecoration(
