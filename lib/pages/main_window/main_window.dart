...
import 'package:taxi_segurito_app/pages/main_window/main_window_functionality.dart';
...
class _MainWindowState extends State<MainWindow> {
  ...
  Widget build(BuildContext context) {
    MainWindowFunctionality functionality = MainWindowFunctionality(context);
    ...
    CustomButton btnIniciarSesionCorreoCelular = new CustomButton(
      onTap: () {
        functionality.onPressedbtnIniciarSesionCorreoCelular();
      },
    ...
    CustomButtonWithIcon btnInicioSesionGoogle = new CustomButtonWithIcon(
        onTap: () {
          functionality.onPressedbtnIniciarSesionGoogle();
        },
    ...
    CustomButtonWithIcon btnInicioSesionFacebook = new CustomButtonWithIcon(
        onTap: () {
          functionality.onPressedbtnIniciarSesionFacebook();
        },
    ...
    CustomButton btnSinSesion = new CustomButton(
      onTap: () {
        functionality.onPressedbtnIniciarSinSesion();
      },
    ...
    TextButton btnCreateAccount = new TextButton(
        onPressed: () {
          functionality.onPressedrtCrearCuenta();
        },
        child: Text(
