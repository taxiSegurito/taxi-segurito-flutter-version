...
import 'package:taxi_segurito_app/pages/driver_register/driver_register_functionality.dart';
import 'package:taxi_segurito_app/pages/driver_list/drivers_list_page.dart';
...
class _DriverRegistrationState extends State<DriverRegistration> {
  ...
  Widget build(BuildContext context) {
    ...
    DriverRegistrationFuncionality functionality =
    ...
    final txtNameDriver = new CustomTextField(
      hint: "Nombre",
    ...
    final txtSecondLastName = new CustomTextField(
    ...
    final txtDriverCI = new CustomTextField(
    ...
    final txtDriverLicense = new CustomTextField(
    ...
    final txtPhoneNumber = new CustomTextField(
    ...
    bool registerDataDriver() {
      ...
      if (_formKey.currentState!.validate() && isValidImageDriver) {
        ...
        functionality = new DriverRegistrationFuncionality(
            context: context,
    ...
    final btnRegister = new CustomButton(
      onTap: () {
        if (registerDataDriver()) {
          functionality.onPressedbtnRegisterDriver();
        }
      },
    ...
    final btnCancel = new CustomButtonWithLinearBorder(
      onTap: () {
        functionality.onPressedbtnCancelRegisterDriver();
      },
      buttonText: "Cancelar",
