...
abstract class ScreenVehicleBase extends StatefulWidget {
  _ScreenVehicleBaseState _screamVehicleBaseState =
      new _ScreenVehicleBaseState();

  late Vehicle vehicle;
  late Driver driver;

  @override
  State<ScreenVehicleBase> createState() {
...
class _ScreenVehicleBaseState extends State<ScreenVehicleBase> {
  @override
